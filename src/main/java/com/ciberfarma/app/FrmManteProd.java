...
public class FrmManteProd extends JFrame {
	...
	void llenaCombo() {
		...
		List<Proveedor> lstProveedoes = em.createQuery("select p from Proveedor p").getResultList();
		cboProveedores.addItem("Seleccione");
		for (Proveedor p : lstProveedoes) {
	...
	void listado() {
		...
		for (Producto p : lstProductos) {
			...
			p.getPre_prod() + " " + p.getObtCategoria().getDescripcion() + "\n");
		}
